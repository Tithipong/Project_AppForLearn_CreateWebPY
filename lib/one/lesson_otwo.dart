...
class LessonOtwo extends StatelessWidget {
  ...
  Widget showLogo4() {
    return Container(
        ...
        height: 200.0,
        child: PhotoView(
            imageProvider: AssetImage('images/1PM25/HTML/4 HTML.PNG')));
  }
  ...
  Widget showLogo5() {
    return Container(
        width: 200.0,
        height: 200.0,
        child: PhotoView(imageProvider: AssetImage('images/1PM25/HTML/5.PNG')));
  }
Widget showtxt1() {
    return Container(
        ...
        child: RichText(
            text: TextSpan(
                ...
                children: <TextSpan>[
              TextSpan(
                  text: ' จะกำหนดหน้าเว็บและ fonts ตัวหนังสือของเว็บเพจ ค่าฝุ่น PM2.5 ของจังหวัดลำพูน',
    ...
    return Container(
        ...
        child: RichText(
            text: TextSpan(
                ...
                children: <TextSpan>[
              TextSpan(
                  text: ' เราจะดึงข้อมูล DATA ที่เราสร้างไว้จาก Python มาใช้ในหน้าเว็บเพจเพื่อที่ให้มาเเสดงผลในหน้าเว็บเพจค่าฝุ่น PM2.5 ของจังหวัดลำพูนได้ตามที่เรากำหนด',
                  style: TextStyle(fontWeight: FontWeight.normal)),
              //fontStyle: FontStyle.italic),
            ]),),);
  }
    ...
    return Container(
        ...
        child: RichText(
            text: TextSpan(
                ...
                children: <TextSpan>[
              TextSpan(
                  text: ' เราจะ run โปรแกรมในส่วนของหน้าต่างของตัว python โดยในหน้าต่าง Teminal จะเเสดงผลเป็นลิ้งค์เว็บเพจ (http://127.0.0.1:5000/) เราสามารถนำไปใส่ในหน้า browser เพื่อดูผลลัพธ์ได้เลย',
                  style: TextStyle(fontWeight: FontWeight.normal)),
              //fontStyle: FontStyle.italic),
            ]),),);
  }
